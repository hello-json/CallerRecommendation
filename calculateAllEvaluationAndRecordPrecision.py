...
for one_faFeature in faFeature_arr:
    ...
    for one_readLen in readLen_arr:
        ...
        for one_depth in depth_arr:
            software_set_arr_precision_str = ""
            for one_software_set in software_set_arr:
                ...
                #software_set_arr_precision_str = software_set_arr_precision_str + str(precision) + "\t"      #生成tsv文件
                software_set_arr_precision_str = software_set_arr_precision_str + str(precision) + ","      #生成csv文件
            software_set_arr_precision_str_noLastT = software_set_arr_precision_str[:-1]
            #resultFile_row = faFeature_dic[one_faFeature][0] + "\t" + faFeature_dic[one_faFeature][1] + "\t" + faFeature_dic[one_faFeature][2] + "\t" + faFeature_dic[one_faFeature][3] + "\t" + RMB + "\t" + highMutationDensePercent + "\t" + one_readLen + "\t" + one_depth + "\t" + software_set_arr_precision_str_noLastT + "\n"      #生成tsv文件
            resultFile_row = faFeature_dic[one_faFeature][0] + "," + faFeature_dic[one_faFeature][1] + "," + faFeature_dic[one_faFeature][2] + "," + faFeature_dic[one_faFeature][3] + "," + RMB + "," + highMutationDensePercent + "," + one_readLen + "," + one_depth + "," + software_set_arr_precision_str_noLastT + "\n"      #生成csv文件
